...
import { setSidebarMode, closeSidebar } from '../../../../store/whiteboardSlice';
...
// ─── Main Sidebar ─────────────────────────────────────────────────────────────
const Sidebar = () => {
  const { isSidebarOpen, sidebarMode, selectedObject } = useSelector((state) => state.whiteboard);
      ...
      <div className="flex items-center justify-between px-3 pt-3 pb-2 border-b border-white/8">
        <div className="flex gap-1">
          <Tab
            ...
            onClick={() => dispatch(setSidebarMode("properties"))}
          />
          <Tab
            icon={Sparkles}
            label="AI"
            active={sidebarMode === "ai"}
            onClick={() => dispatch(setSidebarMode("ai"))}
          />
          <Tab
            icon={Layers}
            label="Layers"
